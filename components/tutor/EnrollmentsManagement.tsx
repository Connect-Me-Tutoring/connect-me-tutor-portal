...
const EnrollmentList = ({
  ...
  const [overlappingAvailabilties, setOverlappingAvailabilites] = useState<Availability[]>([]);
  const [showOverlappingAvailabilites, setShowOverlappingAvailabilties] = useState(true);
